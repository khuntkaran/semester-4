      ...
      appBar: AppBar(
        ...
        actions: [
          Container(child: InkWell(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context){return MainSettingPage();}));
              },
              child: CircleAvatar(radius: 23,backgroundColor: Color(0x94A8A8A8),child: Icon(Icons.settings,color: Colors.white,))
            )
          ),
          Container(
              ...
              child: InkWell(
                ...
                child: CircleAvatar(radius: 23,backgroundColor: Color(0x94A8A8A8),child: Icon(Icons.share,color: Colors.white,))
              )
          ),
        ],
        title:  Container(
